...
const apikey='2983239c7a014546bb1af5f5ca86401f';
...
function displayBlogs(articles){
    ...
    articles.forEach((article) =>{
        ...
        const truncatedDescription = article.description && article.description.length> 150 ? article.description.slice(0,120) + "..." :article.description;
